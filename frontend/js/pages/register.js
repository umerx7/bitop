      ...
      <div class="card" style="width:100%;max-width:440px;">
        ...
        <form id="register-form" novalidate>
          ...
          <div class="input-group" style="margin-bottom:20px;">
            ...
            <input type="text" id="name" name="name" placeholder="Full name" required autocomplete="name" style="width:100%;">
            <label for="name" style="position:absolute;left:44px;top:50%;transform:translateY(-50%);color:var(--text-muted);pointer-events:none;transition:all var(--transition-fast);font-size:0.875rem;">Full name</label>
          </div>
          ...
          <div class="input-group" style="margin-bottom:20px;">
            ...
            <input type="password" id="password" name="password" placeholder="Password (min 8 chars, upper, lower, number, special)" required autocomplete="new-password" style="width:100%;" minlength="8">
          ...
          <div class="input-group" style="margin-bottom:20px;">
            <svg class="icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="6" width="20" height="12" rx="2"></rect><path d="M10 6v-2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg>
            <input type="password" id="confirmPassword" name="confirmPassword" placeholder="Confirm password" required autocomplete="new-password" style="width:100%;">
          ...
          <div class="input-group" style="margin-bottom:20px;">
            ...
            <input type="text" id="referralCode" name="referralCode" placeholder="Referral code (optional)" autocomplete="off" style="width:100%;text-transform:uppercase;">
            <label for="referralCode" style="position:absolute;left:44px;top:50%;transform:translateY(-50%);color:var(--text-muted);pointer-events:none;transition:all var(--transition-fast);font-size:0.875rem;">Referral code</label>
          </div>
